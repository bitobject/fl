defmodule Fl.Accounts.User do
  ...
  """
  def valid_password?(%Fl.Accounts.User{hashed_password: hashed_password}, password)
  ...
  @doc """
  Validates the timezone otherwise adds an error to the changeset.
  """
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, Fl.Repo)
